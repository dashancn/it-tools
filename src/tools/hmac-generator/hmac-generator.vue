...
<template>
  <div flex flex-col gap-4>
    <c-input-text v-model:value="plainText" multiline raw-text placeholder="用于计算哈希的明文..." rows="3" autosize autofocus label="用于计算哈希的明文" />
    ...
    <input-copyable v-model:value="hmac" type="textarea" placeholder="HMAC 结果..." label="文本的 HMAC" />
