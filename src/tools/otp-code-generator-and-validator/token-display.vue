...
<template>
  <div>
    ...
    <div flex items-center>
      <c-tooltip :tooltip="previousCopied ? '已复制！' : '复制上一个 OTP'" position="bottom" flex-1>
      ...
      <c-tooltip :tooltip="currentCopied ? '已复制！' : '复制当前 OTP'" position="bottom" flex-1 flex-basis-5xl>
        <c-button
      ...
      <c-tooltip :tooltip="nextCopied ? '已复制！' : '复制下一个 OTP'" position="bottom" flex-1>
